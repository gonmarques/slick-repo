...
import com.byteslounge.slickrepo.mysql.repository.TestIntegerVersionedEntityRepository

class MySQLIntegerVersionedRepositoryTest extends MySQLAbstractRepositoryTest {
  ...
  it should "updating an integer versioned entity that was meanwhile updated by other process throws exception" in {
    ...
    exception.getMessage should equal("Failed to update entity of type com.byteslounge.slickrepo.mysql.domain.TestIntegerVersionedEntity. Expected version was not found: 1")
  }
